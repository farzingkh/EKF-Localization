...
get_filename_component(_filename "/home/workspace/Sensor-Fusion-EKF/src/robot_pose_ekf/srv/GetStatus.srv" NAME_WE)
add_custom_target(_robot_pose_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_pose_ekf" "/home/workspace/Sensor-Fusion-EKF/src/robot_pose_ekf/srv/GetStatus.srv" ""
)
...
_generate_srv_cpp(robot_pose_ekf
  "/home/workspace/Sensor-Fusion-EKF/src/robot_pose_ekf/srv/GetStatus.srv"
  "${MSG_I_FLAGS}"
  ""
