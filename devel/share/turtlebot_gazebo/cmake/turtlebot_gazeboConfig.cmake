...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/workspace/Sensor-Fusion-EKF/src/turtlebot_simulator/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/workspace/Sensor-Fusion-EKF/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/workspace/Sensor-Fusion-EKF/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/Sensor-Fusion-EKF/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
